...
import { Organization, Member, MemberRole, hasPermission } from '@/types/organization';
        ...
        const loadOrganizations = async () => {
            ...
            try {
                ...
                if (user.currentOrganizationId) {
                    const currentOrg = userOrgs.find(o => o.id === user.currentOrganizationId);
                    if (currentOrg) {
                        setOrganization(currentOrg);

                        // Load current member info
                        const memberInfo = await MemberService.getMember(currentOrg.id, user.id);
                    ...
                    // Load member info
                    const memberInfo = await MemberService.getMember(firstOrg.id, user.id);
                    setMember(memberInfo);
